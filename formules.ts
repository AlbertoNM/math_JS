 ...
 */
export function squarePerimeter(a:number): number {
    return a * 4;
}
 ...
 */
export function pythagoras(a:number = null, b:number = null, c:number = null): number {
    if (a === null){
 ...
 */
export function triangleArea(base:number, b:number, c?:number): number {
    if (base === b && base === c) {
 ...
 */
export function circlePerimeter(diameter:number):number {
 ...
 */
export function circleArea(radious:number):number {
